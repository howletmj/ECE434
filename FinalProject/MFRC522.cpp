 ...
 */
bool RC522::CRC_A_Calculation(uint8_t *SendValues, uint8_t SendCount)
{
...
uint8_t RC522::SelectPICC(void)
{
        ...
        while( (!UID_Complete) )
        {
                ...
                CommunicateWithPICC(Command, ValidBits, InterruptRequestBits, SendCount, &SendValues[0], ReturnCount, &UID[0]); //3 (ANTICOLLISION)
                ...
                while( !(RegisterReturnValue & 0x20) && (AnticollisionLoopIndex < 32) )
                {
                        ...
                        SendValues[4] = UID[2];
                        SendValues[5] = UID[3];
                        SendValues[6] = UID[4]; //BCC

                        CommunicateWithPICC(Command, ValidBits, InterruptRequestBits, SendCount, &SendValues[0], ReturnCount, &UID[0]); //8 (ANTICOLLISION)
 ...
 */
uint8_t RC522::CommunicateWithPICC(uint8_t Command, uint8_t ValidBits, uint8_t InterruptRequestBits, uint8_t SendCount, uint8_t *SendValues,
...
*/
uint8_t RC522::REQA_or_WUPA_Request(uint8_t Request)
{
...
*/
void RC522::DigitalSelfTestOperation (void)
{
...
*/
void RC522::RegisterReadMultiple(uint8_t RegisterAddress, uint8_t Count)
{
...
*/
void RC522::RegisterWriteMultiple(uint8_t RegisterAddress, uint8_t Count, uint8_t *RegisterValues)
{
 ...
 */
bool RC522::IsNewCardPresent(void)
{
...
*/
void RC522::MFRC522_Initialize(void)
{
...
*/
void RC522::ClearRegisterBits(uint8_t RegisterAddress, uint8_t Mask)
{
...
void RC522::SetRegisterBits(uint8_t RegisterAddress, uint8_t Mask)
{
...
*/
void RC522::RegisterWrite(uint8_t RegisterAddress, uint8_t RegisterValue)
{
...
*/
uint8_t RC522::RegisterRead(uint8_t RegisterAddress)
{
